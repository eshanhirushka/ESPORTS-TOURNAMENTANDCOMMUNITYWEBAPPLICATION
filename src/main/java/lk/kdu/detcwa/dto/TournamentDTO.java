...
public class TournamentDTO {
    ...
    public TournamentDTO(int tid, String t_name, String t_type_schedule, String t_reg_start, String t_reg_end, String t_start_date, String t_end_date, String t_type, String t_sport, String t_status) {
        this.tid = tid;
        this.t_name = t_name;
